...
class PublicYearbookController extends Controller
{
    ...
    /**
     * Groups a collection of Graduate models by school name, and within each
     * school splits students into those with granted consent (shown with
     * photo + name, linked to their profile) and those without (name only).
     */

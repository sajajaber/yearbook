...
// Public Yearbook Routes (no authentication required)
Route::prefix('yearbook')->name('public.')->group(function () {
  Route::get('/', [PublicYearbookController::class, 'index'])->name('index');
  ...
  Route::get('/search', [PublicYearbookController::class, 'search'])->name('search');
});

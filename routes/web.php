...
Route::middleware(['auth', 'verified', 'role:admin,editor'])->group(function () {
  ...
  // Event media assignment is an editorial action: admin/editor only.
  Route::post('media/{media}/attach-event', [MediaController::class, 'attachToEvent'])
    ->name('media.attach-event');

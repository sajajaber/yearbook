        ...
        <nav class="site-nav">
            <div class="nav-inner">
                ...
                <div class="nav-links public-nav-links">
                    ...
                    <a href="{{ route('public.events.index') }}" class="nav-item {{ request()->routeIs('public.events.*') ? 'is-active' : '' }}">Events</a>
                    <a href="{{ route('public.graduates.index') }}" class="nav-item {{ request()->routeIs('public.graduates.*') ? 'is-active' : '' }}">Graduates</a>

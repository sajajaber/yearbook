    <style>
        ...
        .settings-add-form input:focus,
        .settings-add-form select:focus {
            border-color: #8ca9c3;
            background: #ffffff;
            box-shadow: 0 0 0 3px rgba(0, 42, 92, 0.06);
        }
        ...
        .settings-add-form textarea::placeholder {
            color: var(--ink-soft);
        }

        .settings-add-form textarea:focus {
            border-color: #8ca9c3;
            background: #ffffff;
            box-shadow: 0 0 0 3px rgba(0, 42, 92, 0.06);
        }
            ...
            <section class="settings-panel" x-show="tab === 'academic-years'" x-cloak>
                ...
                <form method="POST" action="{{ route('academic-years.store') }}" class="settings-add-form">
                    ...
                    <input
                        type="text"
                        name="title"
                        placeholder="Title, e.g. 2026-2027"
                        required>
                    ...
                    <textarea
                        name="dedication"
                        placeholder="Dedication text for this yearbook edition"
                        rows="3">{{ old('dedication') }}</textarea>
                </form>

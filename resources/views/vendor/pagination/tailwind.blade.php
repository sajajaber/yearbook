@if ($paginator->hasPages())
    <nav class="yearbook-pagination" role="navigation" aria-label="Pagination Navigation">
        <style>
            .yearbook-pagination{display:flex;align-items:center;justify-content:center;gap:5px;width:100%;margin:0;padding:0;box-sizing:border-box}
            .yearbook-pagination-summary{display:none}
            ...
            @media(max-width:560px){.yearbook-pagination{gap:4px}.yearbook-pagination-controls{gap:4px}.yearbook-pagination-controls a,.yearbook-pagination-controls span{min-width:34px;height:34px;padding:0 7px}.yearbook-pagination-label span:not([aria-hidden]){display:none}.yearbook-pagination-label{min-width:34px!important;padding:0!important}}
        </style>

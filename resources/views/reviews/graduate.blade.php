                ...
                @if (in_array(Auth::user()->role?->role_name, ['admin', 'reviewer']) && $graduate->publish_status === 'reviewed')
                    <section class="review-decision-card">
                        <div class="decision-intro">
                            ...
                            <div><p class="eyebrow eyebrow-light">Reviewer decision</p><h2>Is this profile ready?</h2><p>Approve the profile or send clear feedback to the editor. Reviewers do not edit profile content.</p></div>
                        </div>

        ...
        <div class="panel academic-year-form-card">
            <div class="panel-header">
                <div>
                    ...
                    <p class="panel-meta">The dedication is used as a featured page in the exported yearbook.</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('academic-years.update', $academicYear->id) }}" class="academic-year-form">
                ...
                <div class="academic-year-grid">
                    ...
                    <label class="academic-field academic-field-full">
                        ...
                        <textarea name="dedication" rows="6" maxlength="2000" placeholder="Dedicated to the students, memories, and moments that made this year unforgettable...">{{ old('dedication', $academicYear->dedication) }}</textarea>

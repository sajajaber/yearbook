        ...
        <div class="panel academic-year-form-card">
            <div class="panel-header">
                <div>
                    ...
                    <p class="panel-meta">Add the edition details first, then give this yearbook a meaningful dedication.</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('academic-years.store') }}" class="academic-year-form">
                ...
                <div class="dedication-section">
                    ...
                    <label class="dedication-field">
                        ...
                        <textarea name="dedication" rows="7" maxlength="2000" placeholder="Dedicated to the students, memories, and moments that made this year unforgettable...">{{ old('dedication') }}</textarea>

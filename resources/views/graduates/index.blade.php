    ...
    <div class="dashboard-wrap graduate-wrap" x-data="{ search: '', status: 'all', year: 'all', campus: 'all', school: 'all', major: 'all', view: 'grid' }">
        <section class="graduate-intro">
            ...
            <div class="graduate-intro-stats">
                <div><strong>{{ $graduates->count() }}</strong><span>profiles</span></div>
        ...
        <section class="filter-ribbon" aria-label="Graduate profile filters">
            <div class="filter-ribbon-heading">
                ...
                </div><button type="button" class="clear-filters" x-show="status !== 'all' || year !== 'all' || campus !== 'all' || school !== 'all' || major !== 'all'" @click="status = 'all'; year = 'all'; campus = 'all'; school = 'all'; major = 'all'">Clear filters</button>
            </div>
        ...
        <section class="graduate-toolbar" aria-label="Graduate profile tools">
            ...
            <div class="graduate-toolbar-tools">
                <div class="view-switcher" aria-label="Profile view">
                    <button type="button" class="view-button" :class="{ 'is-selected': view === 'grid' }" @click="view = 'grid'" aria-label="Grid view" title="Grid view"><span aria-hidden="true">▦</span></button>
        ...
        <section class="graduate-section">
            <div class="section-heading">
                ...
                </div><span class="panel-meta">{{ $graduates->count() }} records</span>
            </div>

        ...
        <form method="POST" action="{{ $isEdit ? route('graduates.update', $graduate) : route('graduates.store') }}" enctype="multipart/form-data" class="graduate-form">
            ...
            <div class="form-main">
                <section class="form-section">
                    ...
                    <div class="form-grid form-grid-two">
                        ...
                        <label class="form-field"><span>Graduation year</span><select name="academic_year_id" id="academic_year_id" required>
                ...
                <section class="form-section">
                    <div class="form-section-heading">
                        <p class="eyebrow">Profile text</p>
                ...
                <section class="form-section">
                    <div class="form-section-heading">
                        <p class="eyebrow">Academic highlights</p>
                        <h2>Achievements and work.</h2>
                    </div>
                    <div class="form-grid">
                ...
                <section class="form-section">
                    <div class="form-section-heading">
                        <p class="eyebrow">University engagement</p>
                ...
                <section class="form-section">
                    <div class="form-section-heading">
                        <p class="eyebrow">Professional exposure</p>
                        <h2>Experience, training and credentials.</h2>
                    </div>
                    <div class="form-grid">
            ...
            <aside class="form-aside">
                ...
                <section class="portrait-upload">
                    <p class="eyebrow">Profile media</p>
                    <h2>{{ $isEdit && $graduate->portraitMedia ? 'Update grad photo' : 'Add grad photo' }}</h2>
                ...
                <section class="form-section form-section-compact">
                    <div class="form-section-heading">
                        <p class="eyebrow">Privacy & publication</p>
                        <h2>Permissions</h2>
                    </div>
                    ...
                    @if ($isAdmin)
                    <label class="form-field"><span>Consent status</span><select name="consent_status">
                    ...
                    <label class="form-field"><span>Publish status</span><select name="publish_status">
                    ...
                    @else
                    <label class="form-field"><span>Consent status</span><select disabled>

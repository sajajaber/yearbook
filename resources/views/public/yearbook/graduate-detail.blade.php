...
<style>
    :root {
        ...
        --profile-radius: 20px;
        --profile-shadow: 0 12px 40px rgba(0, 42, 92, .07);
        --profile-shadow-hover: 0 22px 55px rgba(0, 42, 92, .13);
        --profile-transition: 300ms cubic-bezier(.2, .8, .2, 1)
    }
    ...
    .profile-hero {
        ...
        overflow: hidden;
        isolation: isolate;
        background: radial-gradient(circle at 88% 18%, rgba(255, 176, 52, .16), transparent 25%), linear-gradient(135deg, var(--profile-deep), var(--profile-blue))
    }
    ...
    .profile-hero:before {
        ...
        border-radius: 50%;
        box-shadow: 0 0 0 80px rgba(255, 176, 52, .025), 0 0 0 160px rgba(255, 176, 52, .018);
        pointer-events: none
    }
    ...
    .profile-photo {
        ...
        border-radius: 22px;
        background: linear-gradient(135deg, #24406f, #163261);
        display: flex;
        align-items: center;
        justify-content: center;
        box-shadow: 0 30px 65px rgba(0, 0, 0, .35), 0 0 0 1px rgba(255, 255, 255, .05);
        animation: profilePhotoReveal 800ms cubic-bezier(.2, .8, .2, 1) both;
    ...
    .profile-photo:after {
        ...
        inset: 0;
        pointer-events: none;
        background: linear-gradient(145deg, rgba(255, 255, 255, .15), transparent 35%, rgba(0, 0, 0, .2))
    }

    .profile-photo:hover {
        transform: translateY(-8px) rotate(-1deg) scale(1.015);
        box-shadow: 0 40px 75px rgba(0, 0, 0, .4), 0 0 0 1px rgba(255, 176, 52, .2)
    }
    ...
    .profile-info {
        padding-bottom: 8px;
        animation: profileInfoReveal 800ms 120ms cubic-bezier(.2, .8, .2, 1) both
    }
    ...
    .badge {
        ...
        font-size: .77rem;
        font-weight: 700;
        transition: transform var(--profile-transition), background var(--profile-transition), border-color var(--profile-transition), color var(--profile-transition)
    }

    .badge:hover {
        transform: translateY(-3px);
        background: rgba(255, 176, 52, .14);
        border-color: rgba(255, 176, 52, .4);
        color: #fff
    }
    ...
    .profile-actions .btn {
        transition: transform var(--profile-transition), box-shadow var(--profile-transition), background var(--profile-transition)
    }
    ...
    .section-card {
        ...
        transition: transform var(--profile-transition), box-shadow var(--profile-transition), border-color var(--profile-transition)
    }
    ...
    .quote-box {
        ...
        padding: 30px 34px;
        overflow: hidden;
        border: 1px solid rgba(255, 176, 52, .28);
        border-left: 4px solid var(--profile-gold);
        border-radius: 16px;
        background: linear-gradient(135deg, #fff, rgba(255, 176, 52, .08));
        color: var(--profile-ink);
        font-family: "Merriweather", Georgia, serif;
        font-size: 1.08rem;
        line-height: 1.8;
        box-shadow: 0 8px 30px rgba(0, 42, 92, .04)
    }
    ...
    .sidebar-widget {
        ...
        border-radius: var(--profile-radius);
        background: var(--profile-white);
        box-shadow: 0 8px 30px rgba(0, 42, 92, .045);
        transition: transform var(--profile-transition), box-shadow var(--profile-transition), border-color var(--profile-transition)
    }
    ...
    .sidebar-widget h3:before {
        ...
        border-radius: 50%;
        background: var(--profile-gold);
        box-shadow: 0 0 0 4px rgba(255, 176, 52, .12)
    }
    ...
    .share-btn {
        ...
        font-size: .95rem;
        font-weight: 800;
        transition: transform var(--profile-transition), color var(--profile-transition), background var(--profile-transition), border-color var(--profile-transition), box-shadow var(--profile-transition)
    }
    ...
    .resume-card {
        ...
        border: 1px solid rgba(255, 176, 52, .28);
        border-radius: var(--profile-radius);
        background: linear-gradient(135deg, #fff 0%, rgba(255, 176, 52, .08) 100%);
        box-shadow: var(--profile-shadow);
        transition: transform var(--profile-transition), box-shadow var(--profile-transition), border-color var(--profile-transition)
    }
    ...
    .resume-button {
        ...
        font-size: .86rem;
        font-weight: 800;
        box-shadow: 0 8px 20px rgba(0, 42, 92, .14);
        transition: transform var(--profile-transition), box-shadow var(--profile-transition), background var(--profile-transition)
    }
    ...
    .resume-button:hover {
        ...
        box-shadow: 0 13px 28px rgba(0, 42, 92, .2)
    }
    ...
    .resume-icon {
        ...
        color: #fff;
        font-weight: 900;
        box-shadow: 0 8px 20px rgba(0, 42, 92, .12)
    }

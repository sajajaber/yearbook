...
<style>
    ...
    .graduates-hero::after {
        ...
        animation: graduatesHeroCircleIn 1.4s var(--g-ease) .15s forwards,
            graduatesHeroFloat 10s ease-in-out 1.8s infinite;
    }
    ...
    .graduates-hero::after {
        ...
        animation: graduatesHeroCircleIn 1.6s var(--g-ease) .25s forwards,
            graduatesHeroFloatLarge 13s ease-in-out 2s infinite;
    }
    ...
    .graduates-hero-grid {
        ...
        animation: graduatesHeroGridIn 1.4s ease .1s forwards;
    }
    ...
    .graduates-hero-glow {
        ...
        filter: blur(10px);
        opacity: 0;
        animation: graduatesHeroGlowIn 1.5s ease .45s forwards;
        pointer-events: none;
    }
    ...
    .graduates-kicker {
        ...
        animation: graduatesHeroReveal .8s var(--g-ease) .05s forwards;
    }
    ...
    .graduates-kicker::before {
        ...
        transform: scaleX(0);
        animation: graduatesHeroLineIn .7s var(--g-ease) .4s forwards;
    }
    ...
    .graduates-hero h1 {
        ...
        animation: graduatesHeroTitleIn 1.05s var(--g-ease) .12s forwards;
    }
    ...
    .graduates-hero h1 em {
        ...
        animation: graduatesHeroReveal .9s var(--g-ease) .38s forwards;
    }
    ...
    .graduates-hero-bottom {
        ...
        opacity: 0;
        transform: translateY(25px);
        animation: graduatesHeroReveal .9s var(--g-ease) .52s forwards;
    }
    ...
    .graduates-hero-count {
        ...
        animation: graduatesHeroCountIn .8s var(--g-ease) .68s forwards;
    }
    ...
    @keyframes graduatesHeroReveal {
        from { opacity: 0; transform: translateY(30px); }
        to { opacity: 1; transform: translateY(0); }
    }

    @keyframes graduatesHeroTitleIn {
        from { opacity: 0; transform: translateY(55px); }
        to { opacity: 1; transform: translateY(0); }
    }

    @keyframes graduatesHeroCountIn {
        from { opacity: 0; transform: translateX(25px); }
        to { opacity: 1; transform: translateX(0); }
    }

    @keyframes graduatesHeroGridIn {
        from { opacity: 0; transform: scale(1.06); }
        to { opacity: .08; transform: scale(1); }
    }

    @keyframes graduatesHeroCircleIn {
        from { opacity: 0; transform: scale(.72) rotate(-12deg); }
        to { opacity: 1; transform: scale(1) rotate(0); }
    }

    @keyframes graduatesHeroLineIn {
        from { transform: scaleX(0); }
        to { transform: scaleX(1); }
    }

    @keyframes graduatesHeroFloat {
        0%, 100% { transform: translate3d(0, 0, 0); }
        50% { transform: translate3d(-18px, 20px, 0); }
    }

    @keyframes graduatesHeroFloatLarge {
        0%, 100% { transform: translate3d(0, 0, 0); }
        50% { transform: translate3d(-25px, 15px, 0); }
    }

    @keyframes graduatesHeroGlowIn {
    ...
    .graduates-filter-form {
        display: grid;
        grid-template-columns: minmax(190px, 1.5fr) repeat(4, minmax(115px, 1fr)) auto;
        gap: 7px;
    }
    ...
    .graduate-link:focus-visible .graduate-card {
        box-shadow: 0 0 0 3px rgba(215, 173, 89, .25), 0 18px 38px rgba(15, 23, 42, .075);
    }
    ...
    .graduates-pagination a:hover {
        transform: translateY(-2px);
        border-color: rgba(215, 173, 89, .5);
        background: #fffdf8;
    }
    ...
    @media (max-width: 850px) {
        .graduates-hero { min-height: 560px; padding: 72px 6vw 78px; }
        .graduates-hero-inner { display: block; }
        .graduates-hero h1 { font-size: clamp(54px, 11vw, 100px); }
        .graduates-hero-bottom { display: block; margin-top: 40px; max-width: 700px; }
        .graduates-hero-count { text-align: left; margin-top: 24px; }
        .graduates-hero-copy { max-width: 650px; }
    ...
    @media (max-width: 650px) {
        ...
        .graduates-hero { min-height: 540px; padding: 60px 24px 62px; }
        .graduates-hero h1 { letter-spacing: -3px; }
        .graduates-hero h1 em { letter-spacing: -1px; }
        .graduates-hero-bottom { margin-top: 34px; }
        .graduates-hero-count strong { font-size: 38px; }
        .graduates-filter-form { grid-template-columns: 1fr 1fr; }
        .graduates-header { align-items: flex-start; }
            ...
            @if($graduates->count())
                <div class="graduates-year-group">
                    <div class="graduates-year-heading">
                        <span class="graduates-year-number">{{ $year ? optional($years->firstWhere('id', $year))->title : 'Selected year' }}</span>
                                ...
                                <article class="graduate-card">
                                    <div class="graduate-portrait">
                                        ...
                                        <span class="graduate-badge graduate-degree-badge">
                                            {{ $graduate->degree_level === 'graduate' ? 'Graduate' : 'Undergraduate' }}
                                        </span>
                                    ...
                                    <div class="graduate-card-body">
                                        ...
                                        @endif
                                        @if($graduate->school)
                                            <p class="graduate-school">{{ $graduate->school->name }}</p>
                                        @endif

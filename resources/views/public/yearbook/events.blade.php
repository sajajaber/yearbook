...
<style>
    .events-page {
        --e-ink: var(--ink, #002a5c);
        --e-gold: var(--red, #ffb034);
        --e-muted: #aebdcd;
        --e-line: #d8e3ef;
        --e-paper: #f7fbff;
    ...
    .events-hero::after {
        ...
        animation: eventsCircleIn 1.4s cubic-bezier(.16, 1, .3, 1) .15s forwards, eventsFloat 11s ease-in-out 1.8s infinite;
    }
    ...
    .events-hero-grid {
        ...
        animation: eventsGridIn 1.4s ease .1s forwards;
    }
    ...
    .events-hero-glow {
        ...
        filter: blur(80px);
        animation: eventsGlow 7s ease-in-out 1.5s infinite alternate;
    }
    ...
    .events-kicker {
        ...
        animation: eventsReveal .8s cubic-bezier(.16, 1, .3, 1) .05s forwards;
    }
    ...
    .events-kicker:before {
        ...
        transform: scaleX(0);
        animation: eventsLineIn .7s cubic-bezier(.16, 1, .3, 1) .4s forwards;
    }
    ...
    .events-hero h1 {
        ...
        animation: eventsTitleIn 1.05s cubic-bezier(.16, 1, .3, 1) .12s forwards;
    }
    ...
    .events-hero h1 em {
        ...
        animation: eventsReveal .9s cubic-bezier(.16, 1, .3, 1) .38s forwards;
    }
    ...
    .events-hero-bottom {
        ...
        opacity: 0;
        transform: translateY(25px);
        animation: eventsReveal .9s cubic-bezier(.16, 1, .3, 1) .52s forwards;
    }
    ...
    .events-hero-count {
        ...
        animation: eventsCountIn .8s cubic-bezier(.16, 1, .3, 1) .68s forwards;
    }

    .events-hero-count strong {
        display: block;
        color: #fff;
        font-size: 44px;
        line-height: 1;
    ...
    @keyframes eventsGlow {
        ...
        to {
            transform: translate3d(-35px, -20px) scale(1.08)
        }
    }
    ...
    .events-filter-form {
        display: grid;
        grid-template-columns: minmax(190px, 1.5fr) repeat(4, minmax(120px, 1fr)) auto;
        gap: 7px;
    }
    ...
    .events-filter-button {
        ...
        text-transform: uppercase;
        cursor: pointer;
        transition: transform .35s var(--e-ease), background .25s ease, box-shadow .35s ease;
    }
    ...
    .event-list-item {
        ...
        transition: padding .45s var(--e-ease), background .35s ease, transform .45s var(--e-ease), box-shadow .35s ease;
    }
    ...
    .event-list-title {
        ...
        line-height: 1.3;
        font-weight: 700;
        transition: color .25s ease, transform .4s var(--e-ease);
    }
    ...
    .events-list.view-large .event-list-item {
        ...
        border-radius: 18px;
        background: #fff;
        box-shadow: 0 9px 30px rgba(15, 23, 42, .035);
    }

    .events-list.view-large .event-list-date {
        grid-column: 1/-1;
    }

    .events-list.view-large .event-list-main {
        grid-column: 1;
    }

    .events-list.view-large .event-list-arrow {
        grid-column: 2;
        grid-row: 2;
    }

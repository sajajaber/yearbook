...
<body>
    ...
    <div class="section">
        ...
        <table class="facts-table">
            ...
            <tr>
                <td class="facts-label">Student Reference</td>
                <td>{{ $graduate->student_reference }}</td>
            </tr>
            @endif
            <tr>
                <td class="facts-label">Degree Level</td>
                <td>{{ ucfirst($graduate->degree_level ?? 'Graduate') }}</td>
            </tr>
            @if($graduate->graduation)
            <tr>
                <td class="facts-label">Graduation Year</td>
                <td>{{ \Carbon\Carbon::parse($graduate->graduation->ceremony_date)->format('Y') }}</td>
            </tr>
            @endif
            <tr>
                <td class="facts-label">School</td>
                <td>{{ $graduate->school->name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td class="facts-label">Major</td>
                <td>{{ $graduate->major->name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td class="facts-label">Campus</td>
                <td>{{ $graduate->campus->name ?? 'N/A' }}</td>
            </tr>
        </table>
    </div>

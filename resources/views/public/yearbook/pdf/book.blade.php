...
<body>
    ...
    <div class="chapter">
        ...
        <p style="font-style: italic; text-align: center; padding: 40px 30px;">
            {{ $academicYear->dedication ?: 'To every student, staff member, and moment that made this year unforgettable — this edition is dedicated to you.' }}
        </p>
    </div>

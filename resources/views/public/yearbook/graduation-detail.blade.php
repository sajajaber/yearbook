    ...
    <style>
        ...
        .graduation-eyebrow::before {
            ...
            box-shadow: 0 0 0 5px rgba(255, 176, 52, .15);
        }
        ...
        .graduation-hero-content h1 {
            ...
            animation: fadeUp .8s .28s ease-out both;
        }
        ...
        .graduation-date {
            ...
            animation: fadeUp .8s .42s ease-out both;
        }
        ...
        .graduation-date-icon {
            ...
            background: var(--grad-gold);
            color: var(--grad-ink);
            box-shadow: 0 8px 25px rgba(255, 176, 52, .25);
        }
        ...
        .hero-accent-line {
            ...
            border-radius: 999px;
            background: var(--grad-gold);
            animation: lineReveal .8s .55s ease-out both;
        }
        ...
        .details-card {
            ...
            animation: revealCard .8s ease-out both;
        }
        ...
        .ceremony-card::before {
            ...
            inset: 0 0 auto;
            height: 4px;
            background: linear-gradient(90deg, var(--grad-gold), var(--grad-ink));
        }
        ...
        .ceremony-description p:last-child {
            margin-bottom: 0;
        }

        .ceremony-description ul,
        .ceremony-description ol {
            padding-left: 1.5rem;
            margin: .8em 0 1em;
        }
        ...
        .graduates-heading {
            ...
            gap: 25px;
            margin-bottom: 32px;
            animation: revealCard .8s .2s ease-out both;
        }
        ...
        .graduates-count {
            ...
            font-size: .85rem;
            font-weight: 800;
            box-shadow: 0 6px 20px rgba(0, 42, 92, .06);
        }
        ...
        .graduate-link {
            ...
            color: inherit;
            text-decoration: none;
            animation: graduateReveal .7s ease-out both;
        }
        ...
        .graduate-card {
            ...
            border-radius: 18px;
            background: #fff;
            box-shadow: 0 10px 30px rgba(0, 42, 92, .07);
            transition: transform .45s cubic-bezier(.2, .65, .25, 1), box-shadow .45s, border-color .35s;
        }
        ...
        .graduate-image {
            height: 235px;
            overflow: hidden;
            background: linear-gradient(135deg, var(--grad-ink), var(--grad-blue));
        }

<x-public-layout title="University Digital Yearbook">
    ...
    <section class="public-section">
        ...
        <div class="public-event-grid">
            ...
            <a href="{{ route('public.events', $event) }}" class="public-event-card">
    ...
    <section class="public-section">
        <div class="section-heading">
            ...
            <a href="{{ route('public.events.index') }}" class="text-link">Browse all events <span aria-hidden="true">→</span></a>
        </div>
        <div class="public-event-grid">

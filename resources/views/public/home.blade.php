...
<style>
   ...
   ========================================================= */
    ...
    /* =========================================================
        IMAGE / MEDIA REVEAL (fade + gentle scale-in)
        ========================================================= */
    ...
    /* Graduation grid + mosaic: fade + soft scale rather than
           the default vertical slide, since they're already tiles. */
    .scroll-animations-ready .yb-graduation-card.yb-reveal,
    .scroll-animations-ready .yb-mosaic-item.yb-reveal {
        transform: translateY(24px) scale(0.97);
    }

    .scroll-animations-ready .yb-graduation-card.yb-reveal.is-visible,
    .scroll-animations-ready .yb-mosaic-item.yb-reveal.is-visible {
        transform: translate3d(0, 0, 0) scale(1);
    }

    /* Campus name chips: slide in from the side, staggered. */
    .scroll-animations-ready .yb-campus-name.yb-reveal {
        transform: translateX(28px);
    }

    .scroll-animations-ready .yb-campus-name.yb-reveal.is-visible {
        transform: translate3d(0, 0, 0);
    }
    ...
    .public-footer {
        ...
        margin-top: auto;
        overflow: hidden;
        background: linear-gradient(135deg, #002a5c 0%, #001d42 100%);
        color: #fff;
    ...
    .public-footer-inner {
        ...
        /* FORCE footer sections vertically */
        display: flex;
        flex-direction: column;
        width: 100%;
    }
    ...
    .public-footer-bottom {
        /* Always occupy a completely separate row */
        display: flex;
        width: 100%;
        flex: 0 0 100%;
...
<div class="yearbook-wrapper">
        ...
        <div class="yb-container">
            ...
            <div class="yb-intro-grid">
                ...
                <div>
                    ...
                    <h2 class="yb-intro-heading" data-split-scroll>
        ...
        <div class="yb-container">
            ...
            <div class="yb-archive-inner">
                ...
                <div>
                    ...
                    <h2 class="yb-archive-heading" data-split-scroll>
                        The year<br>
    ...
    <footer class="public-footer">
        ...
        <div class="public-footer-inner">
            ...
            <div class="public-footer-top">
                ...
                <div class="public-footer-contact">
                    ...
                    <div class="footer-contact-item">
                        <span class="footer-contact-icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24">
                                <path d="M7.2 3.5 5 4.4c-.8.3-1.3 1.1-1.1 2 1.2 6.8 6.9 12.5 13.7 13.7.9.2 1.7-.3 2-1.1l.9-2.2c.3-.7 0-1.5-.7-1.9l-2.8-1.4c-.6-.3-1.4-.2-1.8.4l-1.1 1.3c-2.3-1.1-4.1-2.9-5.2-5.2l1.3-1.1c.5-.4.7-1.2.4-1.8L9.1 4.2c-.4-.7-1.2-1-1.9-.7Z"></path>
                            </svg>
                        </span>
            ...
            {{-- ALWAYS BELOW THE ENTIRE TOP SECTION --}}
            <div class="public-footer-bottom">

                <span>
                    © {{ now()->year }} Lebanese International University — Digital Yearbook
                </span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        /* =====================================================
           Letter/word split — turns a heading's text into
           staggered <span> characters while keeping any nested
           tags (em/span) intact for color + italics.
           ===================================================== */
        function splitNode(node, counter) {
            if (node.nodeType === Node.TEXT_NODE) {
                ...
                parts.forEach(function(part) {
                    ...
                    wordSpan.className = 'yb-split-word';

                    Array.from(part).forEach(function(ch) {
                        const charSpan = document.createElement('span');
                        charSpan.className = 'yb-split-char';
                        charSpan.textContent = ch;
                        charSpan.style.setProperty(
                            '--yb-char-delay',
                            Math.min(counter.i * 16, 520) + 'ms'
                        );
                        counter.i += 1;
        ...
        function splitHeading(el) {
            if (!el || el.dataset.ybSplit === 'done') return;
            const counter = {
                i: 0
            };
            ...
            el.classList.add('yb-split-ready');
            el.dataset.ybSplit = 'done';
        }

        if (prefersReducedMotion) {
            /* Skip all JS-driven animation setup; CSS fallback
               below keeps everything visible. */
            return;
        }

        /* Hero heading: split immediately, reveal with the rest
           of the first-load hero sequence. */
        const loadHeading = wrapper.querySelector('[data-split-load]');
        if (loadHeading) {
            splitHeading(loadHeading);
        }
        ...
        requestAnimationFrame(function() {
            ...
            if (loadHeading) {
                requestAnimationFrame(function() {
                    loadHeading.classList.add('is-visible');
                });
            }
        });
        ...
        /* Scroll-triggered headings: split now, reveal on enter. */
        const scrollHeadings = Array.from(
            wrapper.querySelectorAll('[data-split-scroll]')
        );
        scrollHeadings.forEach(splitHeading);

        /* Everything else that fades/slides up as it enters view. */
        const revealItems = Array.from(document.querySelectorAll(
            '.yb-intro-side, .yb-intro-copy, ' +
            '.yb-number-item, .yb-section-header-note, .yb-event, ' +
            '.yb-people-heading > p, .yb-graduation-card, .yb-moments-header, ' +
            '.yb-mosaic-item, .yb-campus-header > p, .yb-campus-name, ' +
            '.yb-archive-inner, .yb-footer-top, .yb-event-image, ' +
            '.yb-reveal-img'
        ));
        ...
        revealItems.forEach(function(item, index) {
            ...
            item.style.setProperty(
                '--yb-delay',
                Math.min((index % 8) * 55, 360) + 'ms'
            );
        });

        wrapper.classList.add('scroll-animations-ready');

        const allObserved = revealItems.concat(scrollHeadings);

<x-app-layout>
    <x-slot name="header">
        <div class="dashboard-heading ai-heading">
            <div>
                <p class="eyebrow">Yearbook office / editorial</p>
    ...
    <div class="dashboard-wrap ai-wrap">
        <section class="ai-intro">
            <div>
                <p class="eyebrow eyebrow-light">Drafts from the writing assistant</p>
                <h2>Give every generated story a human edit.</h2>
                <p>Review the generated text before it becomes part of a graduate profile or campus event.</p>
            </div>
            <div class="ai-intro-count"><strong>{{ $pending->count() }}</strong><span>awaiting review</span></div>
        </section>
        ...
        <section class="ai-section">
            <div class="section-heading">
                <div>
                    <p class="eyebrow">Pending drafts</p>
                    <h2>Review generated content</h2>
                </div><span class="panel-meta">{{ $pending->count() }} records</span>
            </div>
            <div class="ai-grid">
                ...
                <div class="empty-editions">
                    ...
                    <h3>No AI drafts need review.</h3>
                    <p>New biographies and event summaries will appear here after generation.</p>
                </div>
                @endforelse
            </div>
        </section>
